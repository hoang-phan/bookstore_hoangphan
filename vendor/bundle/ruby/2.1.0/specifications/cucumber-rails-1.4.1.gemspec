# -*- encoding: utf-8 -*-
# stub: cucumber-rails 1.4.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-rails-1.4.1"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<ammeter>, ["< 1", ">= 0.2.9"])
      s.add_development_dependency(%q<appraisal>, [">= 0.5.1"])
      s.add_development_dependency(%q<aruba>, [">= 0.4.11"])
      s.add_development_dependency(%q<builder>, ["< 3.2", ">= 2.1.2"])
      ...
      s.add_dependency(%q<ammeter>, ["< 1", ">= 0.2.9"])
      s.add_dependency(%q<appraisal>, [">= 0.5.1"])
      s.add_dependency(%q<aruba>, [">= 0.4.11"])
      s.add_dependency(%q<builder>, ["< 3.2", ">= 2.1.2"])
